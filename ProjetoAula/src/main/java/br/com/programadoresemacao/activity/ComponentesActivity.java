...
import br.com.programadoresemacao.activity.componentes.ComponenteEditActivity;
import br.com.programadoresemacao.activity.componentes.ComponenteRadioGroupActivity;
...
public class ComponentesActivity extends Activity{
    ...
    public void click(View view){
        switch (view.getId()){
            case R.id.componentes_btn_edits:
                intent = new Intent(this, ComponenteEditActivity.class);
                startActivity(intent);
                break;
            case R.id.componentes_btn_radioButtons:
                intent = new Intent(this, ComponenteRadioGroupActivity.class);
                startActivity(intent);
                break;
        }
    }
